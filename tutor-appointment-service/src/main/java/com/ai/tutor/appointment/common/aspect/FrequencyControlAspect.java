package com.ai.tutor.appointment.common.aspect;


import cn.hutool.core.util.StrUtil;
import com.ai.tutor.appointment.common.annotation.FrequencyControl;
import com.ai.tutor.appointment.common.service.FrequencyControlUtil;
import com.ai.tutor.appointment.model.dto.FrequencyControlDTO;
import com.ai.tutor.appointment.utils.RequestHolder;
import com.ai.tutor.appointment.utils.SpElUtils;
...
import static com.ai.tutor.appointment.common.service.FrequencyControlStrategyFactory.TOTAL_COUNT_WITH_IN_FIX_TIME_FREQUENCY_CONTROLLER;
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.ai.tutor.appointment.common.annotation.FrequencyControl)||@annotation(com.ai.tutor.appointment.common.annotation.FrequencyControlContainer)")
