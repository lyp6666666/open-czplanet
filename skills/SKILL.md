...
- 统一 Nacos 参数：
  ...
  - `spring.cloud.nacos.config.namespace: ${NACOS_CONFIG_NAMESPACE:${NACOS_NAMESPACE:3066af4f-57ee-4f4d-80fe-0d2a4e791f7d}}`
...
- discovery namespace 统一通过环境变量覆盖（默认 DEV）：
  - `spring.cloud.nacos.discovery.namespace: ${NACOS_DISCOVERY_NAMESPACE:${NACOS_NAMESPACE:3066af4f-57ee-4f4d-80fe-0d2a4e791f7d}}`
