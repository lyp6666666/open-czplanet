...
ssh -p "$PROXY_REMOTE_PORT" "${PROXY_REMOTE_USER}@${PROXY_REMOTE_HOST}" \
  "cd '$PROXY_REMOTE_PATH' && PUBLIC_DOMAIN='$PUBLIC_DOMAIN' UPSTREAM_HOST='$APP_REMOTE_HOST' USER_WEB_PORT='80' ADMIN_PORT='$PUBLIC_ADMIN_PORT' ADMIN_BASE_PATH='$PUBLIC_ADMIN_BASE_PATH' TLS_CERT_PATH='$TLS_CERT_PATH' TLS_KEY_PATH='$TLS_KEY_PATH' sh scripts/setup_public_domain_proxy.sh"
